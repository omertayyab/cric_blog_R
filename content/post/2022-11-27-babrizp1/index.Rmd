...
```{r results_compare, include=TRUE, out.width=-"100%}
map(
...
Does the data also suggest that they are better openers than the rest and the criticism is completely unfounded? 
